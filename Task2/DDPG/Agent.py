...
#        next_q_values = self.actor_target(next_state)
#        next_q_values = self.critic_target(next_state, next_q_values)
#        q_targets = reward + self.gamma * next_q_values * (1-done)
#        
...
#        actor_q_values = self.actor(state)
#        score = self.critic(state, actor_q_values)
